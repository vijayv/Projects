...
def is_triangle(x,y,z):
    ''' checks to see if the three input integers can mathematically form a triangle

        example: is_triangle(1,2,3) returns yes
        example: is_triangle(1,2,4) returns no
    '''
    try:
        sides = [x,y,z]
...
def test_is_triangle():
    '''
    '''
    x = input("What is side length 1?")
    y = input("What is side length 2?")
    z = input("What is side length 3?")
